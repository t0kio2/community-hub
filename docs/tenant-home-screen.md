...
- `backend/app/views/tenant/home/index.html.erb`
- `backend/app/controllers/tenant/organizations_controller.rb`
- `backend/app/views/tenant/organizations/edit.html.erb`
- `backend/config/routes.rb`
- `backend/test/controllers/tenant/home_controller_test.rb`
- `backend/test/controllers/tenant/organizations_controller_test.rb`
